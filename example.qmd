...
::: {.flashcard-front}
The `flashcards` plugin is a great way to create flashcards for your RevealJS presentations in Quarto. You can shuffle the order of the slides by pressing the `t` key.
:::
