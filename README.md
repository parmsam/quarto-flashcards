...
You'll also notice a `key2` option. This is a keyboard shortcut that can be used to shuffle the slides. By default, it's set to 't' but you can change it to any key you like.
